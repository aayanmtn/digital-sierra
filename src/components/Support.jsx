        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <p className="text-gray-600 text-xl">
                ...
                project and learn how we can help drive your business forward
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <p className="text-gray-600 text-xl">
                We offer 24/7 technical support to ensure smooth operation of
                your applications. Our team proactively monitors and resolves
                issues to minimize downtime and optimize performance.
              </p>
            </div>
            <div className="bg-slate-100 pl-8 py-4">
              <p className="flex items-center text-indigo-600">
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <p className="text-gray-600 text-xl">
                ...
                hrops.plausibilitysolutions@gmail.com to connect with our
                marketing team.
              </p>
            </div>
            <div className="bg-slate-100 pl-8 py-4">
