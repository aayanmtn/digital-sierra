      ...
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        >
          ...
          <div className="flex justify-between flex-wrap px-4">
            ...
            <p className="flex px-4 py-2 text-slate-500">
              <DatabaseIcon className="h-6 text-indigo-600" /> Software
              Development and Management
            </p>
            <p className="flex px-4 py-2 text-slate-500">
              <ServerIcon className="h-6 text-indigo-600" /> Cloud Management
              and DevOps
            </p>
            <p className="flex px-4 py-2 text-slate-500">
              <PaperAirplaneIcon className="h-6 text-indigo-600" /> Website and
